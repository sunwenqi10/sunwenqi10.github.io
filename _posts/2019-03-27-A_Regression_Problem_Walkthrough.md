...
### Plot distributions of the target for building categories(categorical variable)
# Create a list of buildings with more than 100 observations
...
### Visualization of the target vs site eui(numerical variable) and building categories(categorical variable)   
